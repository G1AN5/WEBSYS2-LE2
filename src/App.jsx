        ...
        if (takingExam === null) {
            return (
                <div style={welcomeScreenContentStyle}> {}
                    <h2 style={{ color: '#333', marginBottom: '25px', fontSize: '2em' }}>Kindly provide your name to proceed:</h2>
                    <input
                        type="text"
                        placeholder="..."
                        id="userNameTxtBx"
        ...
        if (takingExam === false) {
            return (
                <div style={quizCompletedContentStyle}>
                    <h2 style={{ fontSize: '28px', color: '#CA8787', fontWeight: 'bold', marginBottom: '20px' }}>
                        Exam Completed!
                    </h2>
                    ...
                    <button
                        ...
                        style={{ fontFamily: 'Cormorant Garamond, sans-serif', padding: '15px 30px', fontSize: '18px', backgroundColor: '#CA8787', color: 'white' }}
                    >
                        Restart Exam
                    </button>
                </div>
    ...
    return (
        <div style={{
            ...
            <div style={headerStyle}>
                ...
                <div style={headerCenterStyle}>WEBSYSTEMS 2 FINAL EXAMINATION</div>
